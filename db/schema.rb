...
ActiveRecord::Schema[8.0].define(version: 2025_11_01_130939) do
  ...
  create_table "solid_queue_claims", force: :cascade do |t|
    t.bigint "job_id", null: false
    t.bigint "process_id", null: false
    t.datetime "created_at", null: false
    t.index ["job_id", "process_id"], name: "index_solid_queue_claims_on_job_id_and_process_id", unique: true
    t.index ["job_id"], name: "index_solid_queue_claims_on_job_id"
    t.index ["process_id"], name: "index_solid_queue_claims_on_process_id"
  end
  ...
  create_table "solid_queue_jobs", force: :cascade do |t|
    ...
    t.index ["queue_name", "priority", "created_at"], name: "sq_jobs_queue_priority_created"
